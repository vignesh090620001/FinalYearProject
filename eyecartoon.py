...
#takes eye landmarks and returns the size of the eye and the center of the eye.
def eye_size(eye):
...
#takes the frame, eye center, and eye size as input and applies the eye overlay on the frame
...
imgEye = cv2.imread('static/assets/img/Eye.png',-1)  
